...
${sortedExp.slice(0, len).map(({
                                                                                                                             jid,
                                                                                                                             exp
                                                                                                                         }, i) => `${i + 1}. ${participants.some(p => areJidsSameUser(jid, p.id)) ? `(${conn.getName(jid)}) wa.me/` : '@'}${jid.split`@`[0]} *Xp ${exp}*`).join`\n`}

*TOP ${len} DIAMANTES  💎*
TU : *${usersLim.indexOf(m.sender) + 1}* DE *${usersLim.length}*
${sortedLim.slice(0, len).map(({
                                                                                                                                                                                                                                                                                                                                                                                                 jid,
                                                                                                                                                                                                                                                                                                                                                                                                 diamond
                                                                                                                                                                                                                                                                                                                                                                                             }, i) => `${i + 1}. ${participants.some(p => areJidsSameUser(jid, p.id)) ? `(${conn.getName(jid)}) wa.me/` : '@'}${jid.split`@`[0]} *Diamantes ${diamond}*`).join`\n`}

*TOP ${len} NIVEL* ⬆️
TU : *${usersLevel.indexOf(m.sender) + 1}* DE *${usersLevel.length}*
${sortedLevel.slice(0, len).map(({
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      jid,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      level
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  }, i) => `${i + 1}. ${participants.some(p => areJidsSameUser(jid, p.id)) ? `(${conn.getName(jid)}) wa.me/` : '@'}${jid.split`@`[0]} *Nivel ${level}*`).join`\n`}`.trim()
