...
let handler = async (m, {conn, text, usedPrefix, command}) => {
    ...
    try {
        ...
        const config = {
            ...
            headers: {'Content-Type': 'application/json', 'Authorization': 'Bearer ' + global.openai_key},
            data: JSON.stringify({
                'model': 'gpt-3.5-turbo',
                'messages': [{
                    role: 'system',
                    content: 'Actuaras como un Bot de WhatsApp el cual fue creado por Azami (Undefined17), tu seras CuriosityBot-MD'
                }, ...chgptdb]
            })
        }
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            let akuariapiresult2 = await translate(`${akuariapijson2.respon}`, {
                                to: 'es',
                                autoCorrect: true
                            })
                            ...
                            try {
                                let syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Azami (Undefined17), tu seras CuriosityBot-MD`
