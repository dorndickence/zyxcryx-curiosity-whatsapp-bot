...
let handler = async (m, {conn, text, usedPrefix, command, participants, groupMetadata}) => {
    ...
    let fakegif = {
        ...
        message: {
            "videoMessage": {
                "title": 'CuriosityBot-MD',
                "h": `Hmm`,
                'seconds': '99999',
                'gifPlayback': 'true',
                'caption': 'Unirte a mi grupo uwu',
                'jpegThumbnail': false
            }
        }
    }
    ...
    try {
        ...
        try {
            ...
            await delay(3 * 3000)
            await conn.sendMessage(res1, {
                text: text,
                mentions: (await conn.groupMetadata(`${res1}`)).participants.map(v => v.id)
            }, {quoted: fakegif})
        ...
        try {
            let res3 = await conn.groupAcceptInvite(code3)
            await delay(3 * 3000)
            await conn.sendMessage(res3, {
                text: text,
                mentions: (await conn.groupMetadata(`${res3}`)).participants.map(v => v.id)
            }, {quoted: fakegif})
        ...
        try {
            let res4 = await conn.groupAcceptInvite(code4)
            await delay(3 * 3000)
            await conn.sendMessage(res4, {
                text: text,
                mentions: (await conn.groupMetadata(`${res4}`)).participants.map(v => v.id)
            }, {quoted: fakegif})
        ...
        try {
            let res5 = await conn.groupAcceptInvite(code5)
            await delay(3 * 3000)
            await conn.sendMessage(res5, {
                text: text,
                mentions: (await conn.groupMetadata(`${res5}`)).participants.map(v => v.id)
            }, {quoted: fakegif})
        ...
        try {
            let res6 = await conn.groupAcceptInvite(code6)
            await delay(3 * 3000)
            await conn.sendMessage(res6, {
                text: text,
                mentions: (await conn.groupMetadata(`${res6}`)).participants.map(v => v.id)
            }, {quoted: fakegif})
        ...
        try {
            let res7 = await conn.groupAcceptInvite(code7)
            await delay(3 * 3000)
            await conn.sendMessage(res7, {
                text: text,
                mentions: (await conn.groupMetadata(`${res7}`)).participants.map(v => v.id)
            }, {quoted: fakegif})
        ...
        try {
            let res8 = await conn.groupAcceptInvite(code8)
            await delay(3 * 3000)
            await conn.sendMessage(res8, {
                text: text,
                mentions: (await conn.groupMetadata(`${res8}`)).participants.map(v => v.id)
            }, {quoted: fakegif})
        ...
        try {
            let res9 = await conn.groupAcceptInvite(code9)
            await delay(3 * 3000)
            await conn.sendMessage(res9, {
                text: text,
                mentions: (await conn.groupMetadata(`${res9}`)).participants.map(v => v.id)
            }, {quoted: fakegif})
        ...
        try {
            let res10 = await conn.groupAcceptInvite(code10)
            await delay(3 * 3000)
            await conn.sendMessage(res10, {
                text: text,
                mentions: (await conn.groupMetadata(`${res10}`)).participants.map(v => v.id)
            }, {quoted: fakegif})
        ...
        try {
            let res11 = await conn.groupAcceptInvite(code11)
            await delay(3 * 3000)
            await conn.sendMessage(res11, {
                text: text,
                mentions: (await conn.groupMetadata(`${res11}`)).participants.map(v => v.id)
            }, {quoted: fakegif})
        ...
        try {
            ...
            await delay(3 * 3000)
            await conn.sendMessage(res12, {
                text: text,
                mentions: (await conn.groupMetadata(`${res12}`)).participants.map(v => v.id)
            }, {quoted: fakegif})
        ...
        try {
            ...
            await delay(3 * 3000)
            await conn.sendMessage(res13, {
                text: text,
                mentions: (await conn.groupMetadata(`${res13}`)).participants.map(v => v.id)
            }, {quoted: fakegif})
        ...
        try {
            ...
            await delay(3 * 3000)
            await conn.sendMessage(res14, {
                text: text,
                mentions: (await conn.groupMetadata(`${res14}`)).participants.map(v => v.id)
            }, {quoted: fakegif})
        ...
        try {
            ...
            await delay(3 * 3000)
            await conn.sendMessage(res15, {
                text: text,
                mentions: (await conn.groupMetadata(`${res15}`)).participants.map(v => v.id)
            }, {quoted: fakegif})
